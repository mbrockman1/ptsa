...
fig += 1
figure(fig)
topoplot(center=(0, 0), radius=0.2, sensors=els,
         values=toPlot, resolution=grid)
topoplot(center=(1.5, 0), radius=0.5, sensors=els,
         values=toPlot, resolution=grid)
topoplot(center=(4, 0), radius=1, sensors=els, values=toPlot, resolution=grid)
topoplot(center=(8.5, 0), radius=2, sensors=els,
         values=toPlot, resolution=grid)
xlim(-0.5, 12)
# axis('on')
# show()
...
fig += 1
figure(fig)
topoplot(center=(0, 0), nose_dir=-45, sensors=els, values=toPlot,
         colors=['black', None, 'black'], resolution=grid)
topoplot(center=(0, 2), nose_dir=-135, sensors=els, values=toPlot,
         colors=['black', None, 'black'], resolution=grid)
topoplot(center=(2, 0), nose_dir=135, sensors=els, values=toPlot,
         colors=['black', None, 'black'], resolution=grid)
topoplot(center=(2, 2), nose_dir=45, sensors=els, values=toPlot,
         colors=['black', None, 'black'], resolution=grid)
xlim(-1, 3)
ylim(-1, 3)
# show()
