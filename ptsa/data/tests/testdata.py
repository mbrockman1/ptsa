...
class TestData():
    def __init__(self):
        ...
        Hz = 10
        d200_10 = N.sin(N.arange(numPoints, dtype=N.float) *
                        2 * N.pi * Hz * numSecs / numPoints)
        Hz = 5
        d200_5 = N.sin(N.arange(numPoints, dtype=N.float) *
                       2 * N.pi * Hz * numSecs / numPoints)
        ...
        Hz = 10
        d50_10 = N.sin(N.arange(numPoints, dtype=N.float) *
                       2 * N.pi * Hz * numSecs / numPoints)
        Hz = 5
        d50_5 = N.sin(N.arange(numPoints, dtype=N.float) *
                      2 * N.pi * Hz * numSecs / numPoints)
