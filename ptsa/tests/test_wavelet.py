...
class test_morlet_multi(TestCase):
    def test_morlet_multi(self):
        ...
        self.assertRaises(ValueError, morlet_multi, [
                          1, 2, 3], [1], 200, [1, 2])
    ...
    def test_phase_pow_multi(self):
        ...
        y_ts = phase_pow_multi([1, 2, 3], dat, [100],
                               widths=6, to_return='phase')
        # ensure correct output shape:
        ...
        z_ts = phase_pow_multi([1, 2, 3], dat, 100, widths=[
                               6], to_return='power')
        # ensure correct output shape:
        ...
        x_ts = phase_pow_multi(
            [4, 9, 8], dat, [100, 200, 300], widths=[6, 5, 4])
        # ensure correct output shape:
        self.assertEqual(np.shape(x_ts), (2, 3, 2, 1000))
        # dat has two identical rows, ensure output has corresponding
        # identities:
